...
export async function singleTest(test: TestEntry, canonicalizer: RDFC10 | undefined = undefined): Promise<TestResult> {
    // The canonicalizer itself must be created. Furthermore, depending on the test
